...
vignette: "%\\VignetteIndexEntry{Mono and Multi-block Data-Driven sparse PLS (mdd-sPLS)}
...
```{r,fig.height=10,fig.width=13,dpi=DPI,out.width= out.width,out.height=out.height}
