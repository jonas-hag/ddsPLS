...
test <- function(){
  ...
  for(i in 157:200){
    ...
    for(i_m in 1:length(pos)){
      ...
      ##########################
      if(toPlot){
        pdf(file = "/Users/hlorenzo/Documents/GitHub/Simulations_2.pdf",width = 15,height = 8)
        ...
        pdf(file = "/Users/hlorenzo/Documents/GitHub/Simulations_R_2.pdf",width = 12,height = 10)
        plot_R_rho()
        dev.off()

        pdf(file = "/Users/hlorenzo/Documents/GitHub/Simulations_sel_x_2.pdf",width = 14,height = 9)
        # postscript("/Users/hlorenzo/Dropbox/Results/Simulations_sel_x.eps", width=14, height=9, onefile=TRUE, horizontal=FALSE)
        # plot_X()
        plot_TVP_TFP_X_rho()
        dev.off()

        pdf(file = paste("/Users/hlorenzo/Documents/GitHub/Simulations_sel_y_2.pdf",sep=""),width = 14,height = 9)
