                             ...
                             ...)
{
  ...
  cat("-------------------------------------------");cat("\n")
  # cat("Total Y variance explained by the predicted values");cat("\n")
  # print(signif(object$Variances$VAR_FINAL[1],2)*100)
  # cat("\n")
  cat("Total Y variance explained by each Super Component");cat("\n")
  oo <- as.numeric(object$Variances$VAR_SUPER_COMPS_ALL_Y)
  names(oo) <- names(object$Variances$VAR_SUPER_COMPS_ALL_Y)
