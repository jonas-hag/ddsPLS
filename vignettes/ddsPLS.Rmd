...
```{r}
datatable(signif(mddsPLS_model_reg$var_selected[[1]],2))
```
...
```{r}
datatable(signif(mddsPLS_model_class$var_selected[[1]],2))
```
...
```{r}
datatable(signif(model_multi_vizu$var_selected[[1]],2))
```
