...
plot(mddsPLS_model_reg,vizu = "weights",variance = "Linear",
     super = T,comp = c(1,2),addY = T,mar_left = 3,pos_legend = "topright",reorder_Y = T)
```
...
```{r,fig.height=7,fig.width=10}
plot(mddsPLS_model_class,vizu = "weights",super=T,comp = c(1,2),addY = T,mar_bottom = 3,mar_left = 3,legend.cex = 0.6,reorder_Y = T)
```
...
```{r, fig.show='hold',fig.width=10, fig.height=5,message=FALSE,eval=T}
...
```{r,fig.width=10, fig.height=6,message=FALSE,eval=T}
...
plot(model_L0,super = T,addY = T,pos_legend = "right",reorder_Y = T)
```
...
plot(model_multi_vizu,vizu = "weights",super = T,comp=1 ,addY = T,mar_left = 5,reorder_Y = T)
```

##### Super-Component 2

```{r,fig.height=10,fig.width=10}
plot(model_multi_vizu,vizu = "weights",super = T,comp=2 ,addY = T,mar_left = 5,reorder_Y = T)
```
