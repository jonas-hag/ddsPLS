...
```{r}
signif(mddsPLS_model_reg$var_selected[[1]],2)
```
...
```{r, fig.show='hold',message=FALSE,eval=T,fig.width=12, fig.height=12,dpi=DPI,out.width= out.width,out.height=out.height}
...
```{r, fig.show='hold',message=FALSE,eval=T,fig.width=12, fig.height=7,dpi=DPI,out.width= out.width,out.height=out.height}
...
```{r}
signif(model_multi_vizu$var_selected[[1]],2)
```
