...
The two panels building this plot are headed with numbers. Red for the error curves and blue for the $\mathbf{Y}$ variable occurence curves. It represents the number of variables selected in the $\mathbf{Y}$ and in the $\mathbf{Y}$ respectively for the model built on the matrices given to the function.
